        ...
        <div class="hidden sm:flex sm:items-center">
            ...
            <div>
                <span class="relative z-0 inline-flex shadow-sm">
                    ...
                    @else
                        <a href="{{ $paginator->previousPageUrl() }}" rel="prev" class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-purple bg-primary border border-dark-purple leading-5 rounded-l-md hover:text-gray-400 transition ease-in-out duration-150" aria-label="{{ __('pagination.previous') }}">
                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                        </a>
                    @endif
                    ...
                    {{-- Next Page Link --}}
                    @if ($paginator->hasMorePages())
                        <a href="{{ $paginator->nextPageUrl() }}" rel="next" class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium text-purple bg-primary border border-dark-purple leading-5 rounded-r-md hover:text-gray-400 transition ease-in-out duration-150" aria-label="{{ __('pagination.next') }}">
