                            ...
                            <form id="update-form" action="{{ route('update-waktu', ['id' => $antrian->id]) }}" method="POST" class="flex text-center">
                                ...
                                <div class="flex items-center">
                                    <div class="relative max-w-sm mr-4">
                                        ...
                                        <input datepicker datepicker-orientation="bottom right" name="datepicker" datepicker-autohide type="text" autocomplete="off" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                                      </div>
                                </div>
                                @else
                                    {{$antrian->plan_date}}
                                                    ...
                                                    <form action="{{ route('update-quantity', $cart->id) }}" method="POST">
                                                        ...
                                                        <tr class="text-primary dark:text-purple border border-primary dark:border-purple">
                                                            ...
                                                            <td class="py-2 text-center">
                                                                <div class="flex justify-center">
                                                                    <input type="number" name="quantity" id="quantity" value="{{$cart->quantity}}" max="9" min="1" class="bg-gray-100 dark:bg-primary text-primary dark:text-purple text-center text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-20 p-2.5">
                                                                </div>
                                                            </td>
            ...
            <div id="popup-modal-{{$antrian->id}}-" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 text-center space-x-10">
                            <svg aria-hidden="true" class="mx-auto mb-4 text-gray-400 w-14 h-14 dark:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah anda yakin ingin menghapus semua item ? </h3>
