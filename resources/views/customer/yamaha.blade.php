...
<div class="text-purple mt-20 font-semibold text-2xl tracking-wide">Yamaha Dealer</div>
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
        @foreach ($dealer as $dealer)
        <div>
            <div class="w-full h-48 md:h-44 bg-purple border border-purple rounded-lg shadow mt-10">
