        ...
        <div>
            <div class="w-full max-w-sm bg-gray-100 dark:bg-purple border border-purple rounded-lg shadow-lg mt-10">
                <div class="px-5 pb-5 mt-4">
                    ...
                    <div class="flex items-center justify-center md:justify-between mt-4">
                        <div class="md:inline block"></div>
                        <a href="{{route('admin.dataDealer')}}" class="text-primary bg-dark-purple hover:bg-violet-600 hover:font-semibold focus:ring-1 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs md:text-sm px-3 md:px-5 py-1.5 md:py-2.5 text-center">Lihat Data</a>
                    </div>
                </div>
            </div>
        </div>
        <div>
            <div class="w-full max-w-sm bg-gray-100 dark:bg-purple border border-purple rounded-lg shadow-lg mt-10">
                <div class="px-5 pb-5 mt-4">
                    ...
                    <div class="flex items-center justify-center md:justify-between mt-4">
                        <div class="md:inline block"></div>
                        <a href="{{route('admin.dataMechanic')}}" class="text-primary bg-dark-purple hover:bg-violet-600 hover:font-semibold focus:ring-1 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs md:text-sm px-3 md:px-5 py-1.5 md:py-2.5 text-center">Lihat Data</a>
                    </div>
                </div>
            </div>
        </div>
