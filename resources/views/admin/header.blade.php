...
<div class="flex items-center justify-center flex-col">
   ...
   <li>
       <a href="{{ route('admin.dashboard') }}" class="flex items-center p-3 mb-4 text-base text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
    ...
    <li>
       <a href="{{ route('admin.dataUser') }}" class="flex items-center p-3 mb-4 text-base text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
    ...
    <li>
       <a href="{{ route('admin.dataDealer') }}" class="flex items-center p-3 mb-4 text-base text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
         <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 hover:text-primary transition duration-75  group-hover:text-primary " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
          <span class="flex-1 ml-3 ">Data Dealer</span>
       </a>
    </li>
    <li>
      <a href="{{ route('admin.dataMechanic') }}" class="flex items-center p-3 mb-4 text-base text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
         <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 hover:text-primary transition duration-75  group-hover:text-primary " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
