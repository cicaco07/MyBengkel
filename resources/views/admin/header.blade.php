...
<div class="flex items-center justify-center flex-col">
   <img class="h-32 w-32 rounded-full" src="{{asset('img/a.jpg')}}">
   <div class="text-purple m-4 text-center">Who Am I</div>
</div>
   <li>
       <a href="admin/dashboard" class="flex items-center p-3 mb-4 text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
    ...
    <li>
       <a href="data-dealer" class="flex items-center p-3 mb-4 text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
    ...
    <li>
       <a href="tambah-dealer" class="flex items-center p-3 mb-4 text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
          ...
          <span class="flex-1 ml-3 ">Tambah Dealer</span>
       </a>
    </li>
@endsection
