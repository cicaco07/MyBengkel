...
@endif
    <div class="p-4 rounded-lg mt-14 bg-gray-100 border border-purple dark:border-none shadow-md dark:bg-secondary">
        <div class="flex flex-col justify-between md:flex-row">
            <div class="text-primary dark:text-purple m-4 font-semibold text-2xl tracking-wide md:w-1/2">Data Mechanic</div>
            <div class="mt-2 md:mt-10 mb-4 md:w-1/2">
                ...
                <div class="flex justify-between mt-4">
                    ...
                    <a href="{{route('admin.dataMechanic')}}" class="text-blue-600">Clear search</a>
                </div>    
                @endif
            </div>
        </div>
            ...
            <div class="relative p-4 bg-gray-100 dark:bg-secondary rounded-lg shadow sm:p-5">
                ...
                <form action="{{ route('admin.createMechanic')}}" method="POST">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label for="dealer_id" class="block mb-2 text-sm font-medium text-primary dark:text-purple">Id Dealer</label>
                            <input type="text" name="dealer_id" id="dealer_id" class="bg-gray-100 dark:bg-primary text-primary dark:text-purple text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="" required="">
                        </div>
                        <div>
