...
<div class="flex items-center justify-center flex-col">
   ...
   <li>
    ...
    <li>
       <a href="antrian" class="text-sm text-gray-900 dark:text white flex items-center p-3 mb-4 text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
