...
@section('menu')
<li>
    <a href="#" class="flex items-center p-3 mb-4 text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
 ...
 <li>
    <a href="#" class="flex items-center p-3 mb-4 text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
       ...
       <span class="flex-1 ml-3 ">Kanban</span>
    </a>
 </li>
 <li>
    <a href="#" class="flex items-center p-3 mb-4 text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
 ...
 <li>
    <a href="#" class="flex items-center p-3 mb-4 text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
       ...
       <span class="flex-1 ml-3 ">Users</span>
    </a>
 </li>
 <li>
    <a href="#" class="flex items-center p-3 mb-4 text-purple rounded-lg hover:bg-dark-purple hover:text-primary hover:font-semibold">
       ...
       <span class="flex-1 ml-3 ">Products</span>
    </a>
 </li>
@endsection