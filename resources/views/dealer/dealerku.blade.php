        ...
        <div class="relative w-full max-w-2xl max-h-full">
            <div class="relative bg-secondary rounded-lg shadow">
                ...
                <form id="editProfileForm" action="{{ route('dealer.update', $user->id_user)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6 mx-6">
                        <label for="dealer_name" class="block mb-2 text-sm font-medium text-purple">Nama Dealer</label>
                        <input type="text" id="dealer_name" name="dealer_name" value="{{ auth()->user()->dealer->dealer_name }}" class="bg-primary border border-secondary text-purple text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="{{ $user->dealer->dealer_name }}">
                    </div>
                    <div class="mb-6 mx-6">
                        <label for="dealer_address" class="block mb-2 text-sm font-medium text-purple">Alamat Dealer</label>
