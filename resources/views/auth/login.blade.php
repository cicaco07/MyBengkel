    ...
    <div class="w-full max-w-sm p-4 bg-secondary rounded-lg shadow sm:p-6 md:p-8">
        <form class="space-y-6" action="#">
            ...
            <div>
                ...
                <input type="email" name="email" id="email" class="bg-transparent primary border-1 border-purple text-purple text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
            </div>
            <div>
                <label for="password" class="block mb-2 text-sm font-medium text-purple">Password</label>
                <input type="password" name="password" id="password" class="bg-transparent border-1 border-purple text-purple text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
            </div>
